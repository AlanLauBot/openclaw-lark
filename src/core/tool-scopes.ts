...
export const TOOL_SCOPES: ToolScopeMapping = {
  ...
  'feishu_doc_permission.list': ['docs:permission.member:read'],
  'feishu_doc_permission.create': ['docs:permission.member:create'],
  'feishu_doc_permission.update': ['docs:permission.member:update'],
  'feishu_doc_permission.transfer_owner': ['docs:permission.member:transfer'],
  ...
  'feishu_im_user_message.send': ['im:message', 'im:message:send_as_bot'],
  'feishu_im_user_message.reply': ['im:message', 'im:message:send_as_bot'],
  'feishu_im_user_fetch_resource.default': ['im:message:readonly'],
  'feishu_im_user_get_messages.default': [
    'im:chat:read',
    'im:message:readonly',
  ...
  'feishu_search_user.default': ['contact:user.base:readonly'],
  'feishu_create_doc.default': [
